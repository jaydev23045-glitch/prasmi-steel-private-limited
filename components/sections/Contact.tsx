        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div className="flex items-center gap-4 mb-2 md:hidden">
              ...
              <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Contact Prasmi Steel Support</h2>
            </div>
            ...
            >
              <div className="hidden md:flex items-center gap-4 mb-8">
                ...
                <h2 className="text-xs font-black uppercase tracking-[0.4em] text-slate-400">Inquiry Portal: Reach Our Metallurgy Experts</h2>
              </div>
              {/* Regional Offices */}
